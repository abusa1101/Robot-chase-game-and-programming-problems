...
//       pixels->data[i].x = ceiling(points->data[i].x);
//     } else {
//       pixels->data[i].x = floor(points->data[i].x - epsilon);
//     }
//     if (rect_vec->data[i].y == tempy)) {
//       pixels->data[i].y = ceiling(points->data[i].y)
//     } else {
...
//   pg_points_t *pixelpts = cd2pixel(points);
